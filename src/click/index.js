...
const translations = {
  ...
  es: {
    click: 'clic',
    help: 'Ejecuta un "clic" sobre un',
    audio: 'Audio',
    audioDescription: 'Usar comando "clic", "clic audio" o "clic multimedia"',
    button: 'Botón',
    buttonDescription: 'Usar comando "clic" o "clic botón"',
    clickHere: 'Clic aquí',
    checkbox: 'Opción',
    checkboxDescription: 'Usar comando "clic" o "clic opción"',
    option: 'Opción',
    color: 'Color',
    colorDescription: 'Usar comando "clic" o "clic color"',
    dates: 'Fechas',
    datesDescription: 'Usar comando "clic" o "clic fecha"',
    file: 'Archivo',
    fileDescription: 'Usar comando "clic" o "clic archivo"',
    image: 'Imagén',
    imageDescription: 'Usar comando "clic" o "clic imagen"',
    link: 'Vínculo',
    linkDescription: 'Usar comando "clic" o "clic vínculo"',
    range: 'Rango',
    rangeDescription: 'Usar comando "clic" o "clic rango"',
    radioButtons: 'Opción única',
    radioButton: 'opción',
    radioButtonsDescription: 'Usar comando "clic" o "clic opción"',
    select: 'Opciones',
    selectDescription: 'Usar comando "clic" o "clic opciones"',
    text: 'Texto',
    textDescription: 'Usar comando "clic" o "clic texto"',
    video: 'Video',
    videoDescription: 'Usar comando "clic", "clic video" o "clic multimedia"',
  },
  pt: {
    click: 'clique',
...
export default {
  ...
  contexts: [{
    ...
    i18n: {
      ...
      es: {
        'command.click': 'click',
        'help.click': 'Ejecuta un "clic" sobre algún elemento',
        'group.click': 'Clic sobre algo',
        'command.press': 'presionar',
        'help.press': 'Ejecuta un "clic" sobre algún elemento',
        'group.press': 'Clic sobre algo',
  ...
  i18n: {
    ...
    es: {
      name: 'Click',
      description: 'Efectúa un "clic" sobre un elemento previamente seleccionado',
    },
    pt: {
      name: 'Clicar',
