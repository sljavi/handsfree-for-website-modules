...
export default {
  ...
  i18n: {
    ...
    es: {
      ...
      'command.remove-line': 'borrar línea',
      'help.remove-line': 'Borrar la última línea de texto',
    ...
    yue: {
      ...
      'help.remove': '刪除最後一個字',
      'group.remove': '刪除部分文字',
      'command.remove-line': '刪除一整行',
      'help.remove-line': '刪除最後一行',
      'group.remove-line': '刪除部分文字',
      'command.clean-up': '清除',
      'help.clean-up': '刪除全部文字',
      'group.clean-up': '刪除部分文字',
      'command.paste': '貼上',
      'help.paste': '貼上己複製的文字',
      'group.paste': '貼上部分文字',
      'command.undo': '復原',
